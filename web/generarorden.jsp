        ...
        <div id="pdf">
            <div class="container">                
                ...
                <div class="row justify-content-start">
                    ...
                    <div class="col-xs-12 col-md-6">
                        <div class="box">
                            <label>${sessionScope.formato.format(sessionScope.ori.fecha)}</label>
                        </div>
                    </div>
                </div>
                <div class="row justify-content-start">
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-xs-12 col-md-12">
                        <c:choose>
                            <c:when test="${sessionScope.canti != 0}">
                                <form action="RegistrarOrdenServlet" method="POST">
                                    <table class="table">
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                            <c:forEach items="${sessionScope.resu}" var="encuestador">
                                                <tr>
                                                    <td>
                                                        ${encuestador.titulo}
                                                    </td>
                            ...
                            <c:otherwise>
                                <br>
                                <br>
                                <h3>Sin encuestas pendientes durante el periodo seleccionado</h3>
                            </c:otherwise>
                        </c:choose>
                    </div>
                </div>
